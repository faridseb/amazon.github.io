...
<header>
                    ...
                    <li>
                        ...
                        <div class="dropdown show ">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item" href="PL.php"> <img src="../images/PRL.jpg" alt=""  class="PL">Premier league</a>
                                <a class="dropdown-item" href="LIGA.php"><img src="../images/LIGAE.png" alt="" class="PL">LIGA</a>
                                <a class="dropdown-item" href="L1.php"><img src="../images/Ligue-1.png" alt="" class="PL">LIGUE1</a>
                                <a class="dropdown-item" href="SA.php"><img src="../images/SEIE.png" alt="" class="PL">SERIE A</a>
                                <a class="dropdown-item" href="BUND.php"><img src="../images/Bundesliga.jpg" alt="" class="PL">BUNDESLIGA</a>
                                <a class="dropdown-item" href="SEL.php"><img src="../images/euro.png" alt="" class="PL">SELECTION</a>
                            </div>
                        </div>
                    </li>
    ...
    <div class="ligue">
            <h2  data-aos="zoom-in"> <img src="Ligue-1.png" alt=""> LIGUE 1</h2>
